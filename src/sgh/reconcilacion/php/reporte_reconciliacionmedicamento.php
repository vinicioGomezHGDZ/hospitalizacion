...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_tipocama as ser on ep.ser_id_fk=ser.tca_id_pk","frm_id_pk,per_nombres || ' ' ||per_apellidopaterno ||' '|| per_apellidomaterno  as persona,frm_fecha,
...
<!-- diseño encabezado pie de pagina -->		
	<htmlpageheader name="myHeader1" style="display:none">
	    ...
	    <tr>
	    	<td align="center"> <b>Formulario de Conciliación de Medicamentos</b><td/>
	...
	<htmlpagefooter name="Chapter2FooterOdd" style="display:none">
		...
		<tr>
			<td>
                    ...
                    Elaborado por : Comite técnico de seguridad de paciente  <br>
 		     </font>	
			</td>
		</tr>
		<tr>
...
<div class="chapter3"><br><br><br><br>
	<table width="100%">
		<tr>
			<th>
			   <H4><center>FORMULARIO CONCILIACIÓN DE MEDICAMENTO </center><H4>
	...
	<table >
		<tr>
			<td><b>Nombre y Apellido: </td><td width="500"></b><font size="3">'.($per[0]["persona"] ?? '') .'</font></td>
		</tr>	
	</table>
	<table>		
		<tr>
			<td><b>Fecha de la entrevista :</b></td>	
			<td width="100"><font size="3">'.($per[0]["frm_fecha"] ?? '') .'</font></td>
			<td><b>Motivo de atención: </b></td><td width="200"><font size="3">'.($per[0]["motivo"] ?? '') .'</font></td>
		</tr>
	</table>
	<table width="100%">		
		<tr>
			<td><b>Ocupación : </b></td> <td width="100"><font size="3">'.($per[0]["frm_ocupacion"] ?? '') .'</font> </td> 
			<td><b>Servicio : </b></td> <td width="125"><font size="3">'.($per[0]["servicio"] ?? '') .'</font></td> 
			<td><b>Edad: </b></td> <td width="200"><font size="3">'.($per[0]["edad"] ?? '') .'</font></td>
		</tr>
	</table>
	<table>
		<tr>
			<td><b>Sexo: </b></td> <td width="50"> <font size="3">'.($per[0]["sexo"] ?? '') .'</font></td> 
			<td><b>Tipo de sangre: </b></td> <td width="100"><font size="3">'.($per[0]["frm_tiposangre"] ?? '') .'</font></td> 
			<td><b>Embarazo/Lactancia: </b></td> <td width="100"><font size="3">'.($per[0]["frm_emblac"] ?? '') .'</font></td>
		</tr>
	</table>
	<table>
		<tr>
			<td><b>Cédula: </b></td> <td width="100"><font size="3">'.($per[0]["per_numeroidentificacion"] ?? '') .'</font></td> 
			<td><b> Peso: </b></td> <td width="50"><font size="3">'.($per[0]["frm_peso"] ?? '') .'</font></td> 
			<td><b> Fuente de información(parentesco) </b></td> <td width="200"><font size="1">'.($per[0]["frm_fueinf"] ?? '') .'</font></td>
		</tr>
	</table>
	<table>
		<tr>
