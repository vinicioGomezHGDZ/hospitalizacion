...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_persona as profe on pro.per_id_fk=profe.per_id_pk","pas.per_nombres || ' '||pas.per_apellidopaterno ||' '|| pas.per_apellidomaterno  as paciente,
  date_part('year',age(pas.per_fechanacimiento)) || ' Años '||date_part('mons',age(pas.per_fechanacimiento)) ||' Meses '|| date_part('days',age(pas.per_fechanacimiento)) || ' Días' as Edad,per_numeroidentificacion
  ,ep.tpa_diagno,tpa_situas,tpa_antece,tpa_evalua,tpa_recome,tpa_punori,tpa_puntra,
   profe.per_nombres || ' '||profe.per_apellidopaterno ||' '|| profe.per_apellidomaterno  as profecional","","tpa_id_pk",$tpa_id_pk,2);	
//$mpdf->useOddEven = 1;
// HTML DE REPORTE 
$html = '
...
<!-- diseño encabezado pie de pagina -->		
	...
	<table>
		<tr>
			<td>
			<font size="2" >
 		Fuente: Acreditación Canadá <br>
 		Redactado por : Lic. Alicia Cazañas Enfermera - Hospital Gustavo Dominguez <br>
 		</font>	
			</td>
		</tr>
		<tr>
