...
# CARGAR DATOS DE ENCABEZADO. array 0
  $per=$Con->Get_Consulta("sgh_mei_ingrelimi ep
    ...
    join sga_adm_tipocama as pis on ca.tca_piso_fk =pis.tca_id_pk
		...
		"," hce_numerohc,per_nombres || '' ||per_apellidopaterno ||' '|| per_apellidomaterno  as paciente,
...
<!-- diseño encabezado pie de pagina -->		
	<htmlpageheader name="myHeader1" style="display:none">
	    ...
	    <td width="20%"><span style="font-weight: bold; font-style: italic;">
	    ...
	    <td width="60%" style="text-align: right;"><h3><small>'.$Con->entidad.'</small></h3></td>
...
<br><br>
	...
	<table width="100%">
		<tr>
			<th>
			   <H4><center>CONTROL DE INGESTA Y ELIMINACIÓN </center><H4> 
			<th>
		</tr>
	</table>
	...
	<table width="100%">
	    <tr>
	        <td>
	         ...
	         <td>
	            <font size="1">Firma y funciòn: '.($resnoalic[0]["resposable"] ?? '').' '.($resnoalic[0]["pro_codigomsp"] ?? '').'</font><font size="2"></font>
	        </td>
	    </tr>
	</table>
	</body> 
