...
// CONSULTAS DE REPORRTE
	# CARGAR DATOS DE ENCABEZADO. array 0
		$per=$Con->Get_Consulta("sgh_ped_prblemas ep
    ...
    $pro=$ConDE->Get_Consulta("sgh_ped_prblemas WHERE hce_id_fk='".$hce_id_pk."' ORDER BY pbl_id_pk DESC","hce_id_fk,pbl_edad,pbl_fecini,pbl_fecdet,pbl_antece,
