...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_tipocama as ser on ca.tca_serv_fk=ser.tca_id_pk","bra_id_pk,per_nombres || '' ||per_apellidopaterno ||' '|| per_apellidomaterno  as persona, cam_codigo as cama , tca_descripcion as servicio,hce_numerohc,per_numeroidentificacion","","bra_id_pk",$bra_id_pk,2);
	# CARGAR DATOS DE ENCABEZADO. array 0
