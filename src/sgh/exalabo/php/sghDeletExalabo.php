<?php
    ...
    //Importo conexion de archivo debido a que mensaje de respuesta no devuelve con metodo de conexion
      ...
      $consulta->bindParam(2, $exa_id_pk, PDO::PARAM_STR, 4000);
      $consulta->bindParam(3, $cat_id_fk, PDO::PARAM_STR, 4000);
      $consulta->bindParam(4, $exa_descrip, PDO::PARAM_STR, 4000);
