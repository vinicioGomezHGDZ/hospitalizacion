...
$per=$Con->Get_Consulta("sgh_mei_intercsol as ep
    JOIN sgh_mei_motdes as mo on mo.int_id_fk= ep.int_id_pk
    ...
    join sga_adm_cama as c on  mo.cam_id_fk = c.cam_id_pk 
    JOIN sga_adm_tipocama as ser on c.tca_serv_fk = ser.tca_id_pk
    ORDER BY int_id_pk DESC LIMIT 1","int_cuclia,(per_nombres ||' ' ||per_apellidopaterno ||' '|| per_apellidomaterno ) as paciente, int_fecha,cam_codigo,mds_grabed,tca_descripcion","","","",5);

//LIBRERIAS DE CORREO ///
ini_set('display_errors',1);
require_once '../../../../php/simphp/PHPMailer-5.2.23/PHPMailerAutoload.php';

// INICIO DE ESTRUCTURA DE ENVIO DE EMAIL ///
...
$mail->FromName = "HOSPITAL GENERAL SANTO DOMINGO";
