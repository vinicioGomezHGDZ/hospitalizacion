...
# CARGAR DATOS DE ENCABEZADO. array 0
		...
		JOIN sga_adm_sexo as se on se.sex_id_pk=per.sex_id_fk","per_nombres ,per_apellidopaterno ||' '|| per_apellidomaterno  as apellido,
			date_part('year',age(per_fechanacimiento)) || ' Años '||date_part('mons',age(per_fechanacimiento)) ||' Meses '|| date_part('days',age(per_fechanacimiento)) || ' Días' as Edad,hce_numerohc,sex_codigo as per_sexo
      ,kar_fecha,kar_medica,kar_id_pk,per_numeroidentificacion","","kar_fecha>='".$fecha."' and hce_id_fk",$hce_id_fk,2);
