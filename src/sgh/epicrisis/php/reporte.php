	...
	<table width="100%">
	   <tr>
	    <td width="50%"  VALIGN="TOP">
	    	...
	    	<table border="1" width="100%" cellspacing="0" cellpadding="2">
	    		<tr>
	    			<td width="" class="th" colspan="2"> <span style="font-weight: bold; font-style: italic;"><font size="2"> 5. DIAGNÓSTICO INGRESO</font> </spant></td>
	    ...
	    <td width="50%"  VALIGN="TOP">
	        <table border="1" width="100%" cellspacing="0" cellpadding="2">
	    		<tr>
	    			<td width="" class="th" colspan="2"> <span style="font-weight: bold; font-style: italic;"><font size="2"> 6. DIAGNÓSTICO EGRESO </font></spant></td>
	    			<th whdth="" class="th" ><font size="2">CIE</font></th>  
	    			<th whdth="" class="th" ><font size="2">PRE</font></th>  
	    			<th whdth="" class="th" ><font size="2">DEF</font></th>  
	    		</tr>';
