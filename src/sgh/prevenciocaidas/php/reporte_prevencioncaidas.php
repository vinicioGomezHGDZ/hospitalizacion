...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_tipocama as ser on ca.tca_serv_fk=ser.tca_id_pk","rcp_id_pk,per_nombres || '' ||per_apellidopaterno ||' '|| per_apellidomaterno  as persona, cam_codigo as cama , tca_descripcion as servicio,hce_numerohc,per_numeroidentificacion","","hce_id_pk",$hce_id_pk,2);
