...
.controller('anexoCtrl',['$scope','$http','upload',function($scope,$http,upload){
...
$scope.actu=function(){
   $http.post('src/sgh/Anexos/php/sghListaAnexo.php',{op:1,idhc:$scope.histoclinica}).success(function (data) {
       console.log(data);
...
$scope.guardar = function(){
    ...
    upload.uploadFile(file, name).success(function(res)
    {
      ...
      if ($scope.text === "pdf" || $scope.text === "png" || $scope.text === "jpg" || $scope.text === "gif" )
      {
         $http.post('src/sgh/Anexos/php/sghInserAnexo.php',{op:1,hcl:$scope.histoclinica ,usu:$scope.usuario,ext:$scope.text}) .success(function(data){
