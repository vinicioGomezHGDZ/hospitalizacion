...
$anamesis=$Cona->Get_Consulta("sgh_mei_anamnesis where hce_id_fk= '".$hcl_id_fk."'ORDER BY ana_fecha DESC ","ana_id_pk,hce_id_fk","","","",5);
...
# CARGAR datos generales anamnesis
  ...
  per_nombres || ' ' ||per_apellidopaterno ||' '|| coalesce(per_apellidomaterno,'') as profecional, pr.pro_codigomsp,ana_hora",
