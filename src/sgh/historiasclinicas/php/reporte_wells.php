...
// CONSULTAS DE REPORRTE
	# CARGAR DATOS DE ENCABEZADO. array 0
		...
		join sga_adm_persona as  per on p.per_id_fk=per.per_id_pk","per_nombres || '' ||per_apellidopaterno ||' '|| coalesce(per_apellidomaterno,'')  as persona,per_numeroidentificacion
		","","ep.hce_id_pk",$hce_id_pk,2);
	# CARGAR DATOS DE caidas. array 0
$prc=$ConAC->Get_Consulta("sgh_mei_wells ","*","","hce_id_pk",$hce_id_pk,2);		
//$mpdf->useOddEven = 1;
// HTML DE REPORTE 
$html = '
...
<div class="header">
	<table width="100%">	
		<tr>	
			<td  width="50%">
				<font size="4"><b>Institución : </b>Hospital General Santo Domingo</font>
			</td>
