...
join sga_adm_persona per on pr.per_id_fk=per.per_id_pk where hce_id_fk='".$hce_id_pk."' order by svd_fecha desc","svd_fecha,svd_hora,svd_diante,svd_pulso,svd_tempe,svd_freres,svd_presis,svd_predia,svd_satoxi,svd_parent,svd_viaora,svd_toteli,svd_orina,svd_drenaj,svd_otros,svd_toting,
...
join sgu_usu_usuario us on usu_id_fk=usu_id_pk
join sga_adm_profesional pr on us.pro_id_fk=pro_id_pk
join sga_adm_persona per on pr.per_id_fk=per.per_id_pk where svd_dieadm is not null AND hce_id_fk='".$hce_id_pk."' order by svd_fecha desc","svd_fecha,svd_hora,svd_diante,svd_pulso,svd_tempe,svd_freres,svd_presis,svd_predia,svd_satoxi,svd_parent,svd_viaora,svd_toteli,svd_orina,svd_drenaj,svd_otros,svd_toting,
 CASE WHEN svd_aseo=true then 'X' end aseo,
 CASE WHEN svd_banio=true then 'X' end baño
,svd_peso,svd_dieadm,svd_numcom,svd_numicc,svd_numdep,svd_actfis,
CASE WHEN svd_camson=true then 'X' end sonda,svd_recvia,
