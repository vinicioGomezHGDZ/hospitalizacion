...
$Conin=New Consulta();
$hce_id_pk=$_GET['h'];
$infor = $Conin->Get_Consulta("sgh_mei_inforalpaci where hce_id_fk='".$hce_id_pk."' ORDER BY inp_fecha DESC","inp_id_pk,inp_fecha ", "", "", "", 5);
...
<table width="100%" style="vertical-align: bottom; font-family: serif; font-size: 8pt;
	    ...
	    <td width="50%" style="text-align: right; "><h2>'.$Conin->entidad.'</h2></td>
