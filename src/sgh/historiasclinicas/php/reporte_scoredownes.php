...
$daw=$Cond->Get_Consulta("sgh_ped_dawnes where hce_id_fk='".$hce_id_pk."' ORDER BY scd_id_pk DESC","*","","","",5);       
//$mpdf->useOddEven = 1;
// HTML DE REPORTE 
...
<table border="1" width="100%" cellspacing="0" cellpadding="2">
	...
	for ($i=0; $i <sizeof($daw) ; $i++) { 
		$html.='
			<tr>
				<th><font size=3><center>'.$daw[$i]["scd_fecha"].'</center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_sibila"].'</center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_tiraje"].'  </center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_frespi"].'  </center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_frecar"].'  </center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_ventil"].'  </center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_cianos"].'  </center></font></th>
				<th><font size=3><center>'.$daw[$i]["scd_total"].' </center></font></th>
			</tr>
		';
	}
