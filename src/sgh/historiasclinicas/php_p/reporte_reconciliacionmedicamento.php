...
$Conre=New Consulta();
$entidad=$Conre->entidad;
$fi=$_GET['fi'];
$fa=$_GET['fa'];

$hce_id_fk=$_GET['h'];
// CONSULTAS DE REPORRTE
$recon=$Conre->Get_Consulta("sgh_mei_reoncimedi where  frm_fecha >='$fi' and  frm_fecha <='$fa'  and  hce_id_fk='".$hce_id_fk."' ORDER BY frm_fecha DESC","frm_id_pk,frm_fecha","","","",5);
$html = ' 
