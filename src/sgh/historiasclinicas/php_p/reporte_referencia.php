...
$Conrefed=New Consulta();
$hce_id_fk=$_GET['h'];
$fi=$_GET['fi'];
$fa=$_GET['fa'];
// CONSULTAS DE REPORRTE
	# CARGAR DATOS DE ENCABEZADO. array 0
		$refd=$Conrefed->Get_Consulta("sgh_mei_referencia WHERE ref_fecha >='$fi' and  ref_fecha <='$fa' and  hce_id_fk='".$hce_id_fk."' ORDER BY ref_fecha DESC","ref_id_pk,ref_fecha,hce_id_fk","","","",5);
...
<!-- diseño encabezado pie de pagina -->		
	...
	<htmlpagefooter name="Chapter2FooterOdd" style="display:none">
	    ...
	    <tr>
            <br> <br>
	    <td width="50%" VALIGN="TOP"><H5>MSP-DNEAIS/form. 053/ene/2014</H5></td>
...
$dia=$$Condi->Get_Consulta("sgh_mei_drd
			...
			JOIN sgh_mei_codigocie10 as c10  on d.c10_id_fk=c10.c10_id_pk","DISTINCT c10_nombre as Diagnostico,c10_codigo as cie_10,dia_resp,sgh_conbiertepre('1',dia_resp) as pre,sgh_conbiertepre('2',dia_resp) as def
","","ref_id_fk",$ref_id_pk,2);
	  ...
	  <table>
			...
			<table  border="1" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td><font size=1><center>'.$inor[0]["per_numeroidentificacion"].'</center></font></td>
		    ...
		    <table border="1" width="100%" cellspacing="0" cellpadding="0">
		    	...
		    	<tr>
		    		...
		    		<td height="16"><font size=1>'.$dia[$d]["diagnostico"].'</font></td>
		    		<td width="20" height="16"><font size=1><center>'.$dia[$d]["cie_10"].'</font></center></h6></H6></td>
		    		<td width="20" height="16"><font size=1><center>'.$dia[$d]["pre"].'</font></center></h6></H6></td>
		    		<td width="20" height="16"><font size=1><center>'.$dia[$d]["def"].'</font></center></h6></H6></td>
