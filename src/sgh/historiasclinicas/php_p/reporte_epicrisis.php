...
for ($r=0; $r <count($epicr) ; $r++) {
	...
	<div class="noheader">
		<table width="100%" style="vertical-align: bottom; font-family: serif; font-size: 8pt;
            ...
            <td width="70%" style="text-align: right; "><h3>'.$entidad.'</h3></td>
...
<!-- 2 hoja  -->	
	...
	<table width="100%">
	   <tr>
	    <td width="50%"  VALIGN="TOP">
	    	...
	    	<table border="1" width="100%" cellspacing="0" cellpadding="2">
	    		<tr>
	    			<td width="70" class="th" colspan="2"> <span style="font-weight: bold; font-style: italic;"> <font size="2">5. DIAGNÓSTICO INGRESO </spant></td>
	    			<th whdth="10" class="th" ><font size="2">CIE</font></th>  
	    			<th whdth="10" class="th" ><font size="2">PRE</font></th>  
	    			<th whdth="10" class="th" ><font size="2">DEF</font></th>  
	    		</tr>';
    ...
    for ($i = 0; $i <6; $i++) {
        ...
        $html .= '<tr>
	    		   		...
	    		   		<td widt="0.1%"><font size="1">'.$dn.'</font></td>
	    		   		<td widt="70"><font size="1">' . ($DiagI[$i]["detalle"] ?? '') . '</font></td>
	    		   		<td widt="10"><font size="1"><center>' . ($DiagI[$i]["cie"] ?? '') . '</center></font></td>
	    		   		<td widt="10"><font size="1"><center>' . ($DiagI[$i]["pre"] ?? '') . '</center></font></td>
	    		   		<td widt="10"><font size="1"><center>' . ($DiagI[$i]["def"] ?? '') . '</center></font></td>
	    				</tr>';
    }
    $html .= '
		  	</table>
	    ...
	    <td width="50%"  VALIGN="TOP">
	        <table border="1" width="100%" cellspacing="0" cellpadding="2">
	    		<tr>
	    			<td width="85" class="th" colspan="2"> <span style="font-weight: bold; font-style: italic;"><font size="2"> 6. DIAGNÓSTICO EGRESO </font></spant></td>
	    			<th whdth="5" class="th" ><font size="2">CIE</font></th>  
	    			<th whdth="5" class="th" ><font size="2">PRE</font></th>  
	    			<th whdth="5" class="th" ><font size="2">DEF</font></th>  
	    		</tr>';
    for ($i = 0; $i < 6; $i++) {
        $dne=$i+1;
        $html .= '<tr>
                         <td widt="0.1%"><font size="1">'.$dne.'</font></td>
	    		   		<td widt="85"><font size="1">' . ($DiagE[$i]["detalle"] ?? '') . '</font></td>
	    		   		<td widt="5"><font size="1"><center>' . ($DiagE[$i]["cie"] ?? '') . '</center></font></td>
	    		   		<td widt="5"><font size="1"><center>' . ($DiagE[$i]["pre"] ?? '') . '</center></font></td>
	    		   		<td widt="5"><font size="1"><center>' . ($DiagE[$i]["def"] ?? '') . '</center></font></td>
	    				</tr>';
    }
    $html .= '
	    	</table>
