...
// CONSULTAS DE REPORRTE
    ...
    # CARGAR Datos general  
        $gli=$ConDI->Get_Consulta("sgh_mei_glicemia where hgi_dia>='$fi' and hgi_dia <='$fa' and hce_id_fk= '".$hce_id_fk."' ORDER BY hgi_dia DESC","hgi_glicem,hgi_esquem,hgi_espaco,hgi_totadm,hgi_obcerv,hgi_dia || ' ' ||hgi_fecha fecha","","","",5);
				//print_r ($DiagI); 
// HTML DE REPORTE 
