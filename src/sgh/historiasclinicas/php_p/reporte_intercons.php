...
$entidad=$Coninter->entidad;
$hce_id_fk=$_GET['h'];
$fi=$_GET['fi'];
$fa=$_GET['fa'];
// CONSULTAS DE REPORRTE

$inter=$Coninter->Get_Consulta("sgh_mei_intercsol WHERE int_fecha>='$fi' and int_fecha <='$fa' and hce_id_fk='".$hce_id_fk."' ORDER BY int_fecha DESC","int_id_pk,int_fecha","","","",5);
