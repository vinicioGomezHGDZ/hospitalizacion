...
$Contr=New Consulta();
$entidad=$Contr->entidad;
$hce_id_fk=$_GET['h'];
$fi=$_GET['fi'];
$fa=$_GET['fa'];

//$mpdf->useOddEven = 1;
$tras=$Contr->Get_Consulta("sgh_mei_tpansfe where tpa_fecha >='$fi' and tpa_fecha <='$fa' and hce_id_fk='".$hce_id_fk."' ORDER BY tpa_fecha DESC ","tpa_id_pk,tpa_fecha ","","","",5);
...
// CONSULTAS DE REPORRTE
  ...
  ,ep.tpa_diagno,tpa_situas,tpa_antece,tpa_evalua,tpa_recome,tpa_punori,tpa_puntra,
   profe.per_nombres || ' '||profe.per_apellidopaterno ||' '|| profe.per_apellidomaterno  as profecional,tpa_fecha","","tpa_id_pk",$tpa_id_pk,2);
