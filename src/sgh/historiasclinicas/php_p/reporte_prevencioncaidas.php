...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_tipocama as ser on ca.tca_serv_fk=ser.tca_id_pk","rcp_id_pk,per_nombres || '' ||per_apellidopaterno ||' '|| per_apellidomaterno  as persona, cam_codigo as cama , tca_descripcion as servicio,per_numeroidentificacion","","hce_id_pk",$hce_id_pk,2);
	# CARGAR DATOS DE caidas. array 0
$prc=$ConAC->Get_Consulta("sgh_ped_caidaspa where rcp_fecha>='$fi'  and rcp_fecha<='$fa' and hce_id_fk='$hce_id_pk' ORDER BY rcp_fecha DESC ","*","","","",5);
//$mpdf->useOddEven = 1;
// HTML DE REPORTE 
$html = '
