...
$esge = $Conesg->Get_Consulta("sgh_mei_escgeria where esg_fecha >='$fi' and esg_fecha <='$fa' and hce_id_fk='".$hce_id_fk."' ORDER BY esg_fecha DESC","hce_id_fk,esg_id_pk,esg_fecha", "", "","" ,5);
  ...
  <table width=100%>
	...
	<table border="1" width="100%" cellspacing="0" cellpadding="2">
		...
		<tr>
			...
			<tr>
			<td>
				<font size=2>Provlema neuro psicologico <br> (Demencia o Depresión)</font>
			</td>
			<td>
