...
$Conead=New Consulta();
$entidad=$Conead->entidad;
$hce_id_fk=$_GET['h'];
$fi=$_GET['fi'];
$fa=$_GET['fa'];
$eventop=$Conead->Get_Consulta("sgh_mei_eventosadver  where fed_fecha>='$fi' and  fed_fecha<='$fa'  and hce_id_fk='".$hce_id_fk."' ORDER BY fed_fecha DESC","fed_id_pk,fed_fecha","","","",5);
...
<!-- diseño encabezado pie de pagina -->		
	<htmlpageheader name="myHeader1" style="display:none">
	    ...
	    <tr>
		    ...
		    <td width="20%" style="text-align: center; ">'.$fi.'</td>
	    </tr>
...
JOIN sga_adm_persona as peh  on pas.per_id_fk= peh.per_id_pk","tca_descripcion,fed_fecha, (peh.per_nombres ||' '||peh.per_apellidopaterno || ' ' ||peh.per_apellidomaterno) AS usuario,
...
<!-- primera hoja  -->
	...
	<table width="100%">
		<tr>
			<th>
			   <H4><center>FORMULARIO DE NOTIFICACIÓN Y EVENTOS ADVERSOS<br>'.$entidad.'</center><H4>
