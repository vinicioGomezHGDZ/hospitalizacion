...
sgh_combercionmotivoreferencia('19',fed_tipcla) as bajo_impacto,fed_tipcla,per_numeroidentificacion","","fed_id_pk",$fed_id_pk,2);
...
<!-- primera hoja  -->
	...
	<table width="100%">
		<tr>
			<th>
			   <H4><center>FORMULARIO DE NOTIFICACIÓN Y EVENTOS ADVERSOS<br>'.$Con->entidad.'</center><H4>
