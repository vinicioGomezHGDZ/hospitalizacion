...
// CONSULTAS DE REPORRTE
    ...
    join sga_adm_tipocama as ser on ca.tca_serv_fk=ser.tca_id_pk","bra_id_pk,per_nombres || '' ||per_apellidopaterno ||' '|| per_apellidomaterno  as persona, cam_codigo as cama , tca_descripcion as servicio,hce_numerohc","","bra_id_pk",$bra_id_pk,2);
	# CARGAR DATOS DE ENCABEZADO. array 0
...
<br><br>
	<table width="100%">	
		...
		<tr>	
			...
			<td  width="50%">
				<font size="4"><b>Historia Clìnica : </b>'.($per[0]["hce_numerohc"] ?? '') .' </font>
			</td>		
		</tr>
	...
	<tr><td>
      ...
      <table>
      		<tr> <td><font size=2>Fuente: Acreditación cadaná</font></td>
			</tr>
      </table>
	</body> 
	</html>
...
$mpdf->writeHTML($html);
$mpdf->Output('Escala de branden modificada','I');
?>